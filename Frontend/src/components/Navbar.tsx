...
const menuItems = [
  ...
  { id: 4, label: "Mapa", path: "/mapa", icon: <FaMapMarkerAlt /> },
  {
    ...
    subItems: [
      ...
      { id: 11, label: "Actividades", path: "/cultivo/tipo_actividad/" },
      { id: 12, label: "Actividades", path: "/cultivo/actividades" },
    ],
  },
  { id: 13, label: "Finanzas", path: "/finanzas", icon: <FaDollarSign /> },
  { id: 14, label: "Plagas", path: "/plagas", icon: <FaBug /> },
  { id: 15, label: "Inventario", path: "/inventario", icon: <FaBox /> },
  {
    ...
    icon: <GiProcessor />,
    subItems: [
      { id: 17, label: "Evapotranspiración", path: "/iot/evapotranspiracion", icon: <FaCloudRain /> },
      { id: 18, label: "Sensores", path: "/iot/sensores", icon: <FaTachometerAlt /> },
      { id: 19, label: "Humedad", path: "/iot/humedad", icon: <FaTemperatureHigh /> },
    ],
  },
];
