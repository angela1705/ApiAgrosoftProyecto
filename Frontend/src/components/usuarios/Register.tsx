...
import api from '@/components/utils/axios'; // ✅ Usa tu instancia de Axios
  ...
  return (
    ...
    >
      ...
      <motion.div animate={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 20 }} transition={{ duration: 0.5, delay: 1 }}>
        <Button fullWidth disabled={loading} sx={{ backgroundColor: '#2ecc71' }} type="submit" variant="contained">
          {loading ? 'Registrando...' : 'Registrarse'}
        </Button>
      </motion.div>

      <Typography sx={{ textAlign: 'center', color: '#718096', fontSize: '0.9rem', mt: 1 }} variant="body2">
        ¿Ya tienes cuenta?{' '}
